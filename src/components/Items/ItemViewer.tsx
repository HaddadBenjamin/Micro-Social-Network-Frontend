...
const ItemViewer = (props: any) => {
    ...
    function SetDefaultImageOnError(event: any) {
        var defaultImageUrl = `${window.location.origin.toString()}/http_code_404_error.jpg`;

        event.target.src = defaultImageUrl;
    }

    function calculDamage(minMin: any, minMax: any, maxMin: any, maxMax: any) {
    ...
    function onSearch(searchResult: any) {
        setItems(props.items);
        setFilteredItems(searchResult.elements);
        setSearchTerm(searchResult.searchTerm);
    }

    function searchFilter(item: Item, searchTerm: any) {
